<!--
  EDIT STUDENT FORM (Day 6)
  ----------------------------------------------------------
  Rename to student_edit.php.
  - Read ?id= from $_GET, SELECT that student, pre-fill every field's value=""
  ...
  <div class="container" style="max-width: 600px;">
    <div class="card">
      <div class="card-body">
        ...
        ?>
        <form method="POST" action="services/update-student" enctype="multipart/form-data" novalidate>
          ...
          <div class="mb-3">
            ...
            <select class="form-select" name="course" required>
              <option value="web-development"
                  <?= $result->course === 'web-development' ? 'selected' : '' ?>>
                  Web Development
              </option>

              <option value="data-science"
                  <?= $result->course === 'data-science' ? 'selected' : '' ?>>
                  Data Science
              </option>

              <option value="cyber-security"
                  <?= $result->course === 'cyber-security' ? 'selected' : '' ?>>
                  Cyber Security
              </option>
          </select>
